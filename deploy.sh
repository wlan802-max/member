...
main() {
    ...
    log "   e) supabase_migration_event_registrations_committees.sql"
    log "   f) supabase_migration_phase3_advanced_features.sql"
    log "   g) supabase_migration_phase1_quick_wins.sql"
    log ""
    log "2. Configure DNS"
